...
Select employee_id, last_name, first_name, levels, hire_date 
from employee
order by levels desc 
limit 1;

/* Q2: Which countries have the most Invoices? only top 5 countries */

select count(*) as ab, billing_country
from invoice
...
/* Q5: Who are the top 5 best customer? The customer who has spent the most money will be declared the best customer. 
